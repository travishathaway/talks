...
@psycopg2_cur()
def get_amenity_data_by_city(cursor, sql, cities: Sequence[str], amenity: str) -> Sequence[NamedTuple]:
    """
...
@psycopg2_cur()
def get_parking_area_by_city(cursor, sql, cities: Sequence[str]) -> Sequence[NamedTuple]:
    """
